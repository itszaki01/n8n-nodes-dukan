...
export const productCreateDescription: INodeProperties[] = [
	...
	// {
	// 	displayName: 'Store Stock Variable',
	// 	name: 'store_stock_variable',
	// 	type: 'string',
	// 	default: '',
	// 	displayOptions: {
	// 		show: {
	...
	// 		},
	// 	},
	// 	description: 'MongoDB ObjectId of store stock variable (optional)',
	// 	routing: {
	// 		send: {
	// 			type: 'body',
	// 			property: 'store_stock_variable',
	// 			value: '={{$parameter.store_stock_variable !== "" ? $parameter.store_stock_variable : undefined}}',
	// 		},
	// 	},
	// },
	{
	...
	{
		displayName: 'Default Confirmation Member',
